...
namespace Pinvoke
{
    ...
    public class CaptureDevice
    {
        ...
        public bool Attach2()
        {
            ...
            deviceHandle = Avicap32.capCreateCaptureWindow("", Constants.WS_VISIBLE | Constants.WS_CHILD, 0, 0, 320, 240, pcb.Handle, 0);
            return User32.SendMessage(deviceHandle, Constants.WM_CAP_DRIVER_CONNECT, (IntPtr)deviceNumber, (IntPtr)0).ToInt32() > 0;            
        }
