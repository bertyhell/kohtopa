...
public class BuildingDialog extends JDialog {
	...
	public static void show(Frame owner, int buildingId, boolean newBuilding) {
		if (instance == null) {
			instance = new BuildingDialog(owner, buildingId, newBuilding);
		}
		instance.fillInfo(newBuilding);
		instance.setVisible(true);
	}

	private BuildingDialog(Frame owner, int buildingId, boolean newBuilding) {
		...
		JButton btnAnnuleer = new JButton(Language.getString("Cancel"), new ImageIcon(getClass().getResource("/images/cancel.png")));
		btnAnnuleer.addMouseListener(new MouseAdapter() {
		...
		pnlButtons.add(btnAnnuleer);

		JButton btnVerder = new JButton(Language.getString("Update"), new ImageIcon(getClass().getResource("/images/OK.png")));
		btnVerder.addMouseListener(new MouseAdapter() {
